...
class CreateCategoryDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreateCategoryDto
        //val modelInstance = CreateCategoryDto()
        ...
        // to test the property `printerId` - Printer ID for kitchen routing
        should("test printerId") {
            // uncomment below to test the property
            //modelInstance.printerId shouldBe ("TODO")
        }
