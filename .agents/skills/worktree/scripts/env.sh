...
#
# Lives in: .agents/skills/worktree/scripts/env.sh
# Does not create git worktrees. Prefer bootstrap.sh for a full cold-checkout
# bootstrap (env + Node check + pnpm install).
#
...
#
# Usage:
#   bash .agents/skills/worktree/scripts/env.sh
#   bash .agents/skills/worktree/scripts/env.sh --print
#   bash .agents/skills/worktree/scripts/env.sh --force
#   bash .agents/skills/worktree/scripts/env.sh --sync-android
#   bash .agents/skills/worktree/scripts/env.sh /path/to/wt
...
sync_android_local_properties() {
  ...
  {
    echo "# Managed Sentry keys by worktree skill — do not commit"
...
render() {
  cat <<EOF
# Generated by .agents/skills/worktree/scripts/env.sh — do not commit.
